  ...
  return (
    ...
    >
      <div class="space-y-4">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div class="flex items-center gap-2 self-start sm:self-auto bg-[#F0EEE9]/80 border border-[#E2DFD8] rounded-xl px-3 py-1.5 shadow-2xs">
            <label for="seat-input-crm" class="text-xs font-semibold text-[#6F7173] uppercase tracking-wider">
              Mailboxes:
            </label>
            <input
              id="seat-input-crm"
      ...
      <Show when={billingCycle() === "annual"}>
        <div class="p-3 rounded-xl bg-emerald-50/90 border border-emerald-200 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          ...
          <span class="text-[11px] font-mono text-emerald-800 bg-emerald-100/80 border border-emerald-300/60 px-2 py-0.5 rounded-full font-semibold self-start sm:self-auto">
