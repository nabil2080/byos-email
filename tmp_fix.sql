-- LAB-ONLY temporary repair fixture: NOT a migration (see infra/postgres/init/*).
-- Re-applies tombstone/deleted status for devices that missed 006/007
-- due to volume-cached DB. Verification scripts must VERIFY, not re-apply.
