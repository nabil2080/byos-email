...
func main() {
	...
	http.HandleFunc("/v1/auth/recovery-verify", withSecurityHeaders(withCORS(recoveryVerifyHandler)))
	http.HandleFunc("/v1/auth/change-password", withSecurityHeaders(withCORS(changePasswordHandler)))
	...
	http.HandleFunc("/v1/auth/invitations/verify", withSecurityHeaders(withCORS(invitationVerifyHandler)))
	http.HandleFunc("/v1/auth/invitations/claim", withSecurityHeaders(withCORS(invitationClaimHandler)))
	...
	http.HandleFunc("/v1/organizations/{org_id}/mailboxes/{mailbox_id}", withSecurityHeaders(withCORS(mailboxItemHandler)))
	http.HandleFunc("/v1/organizations/{org_id}/mailboxes/invite", withSecurityHeaders(withCORS(mailboxInviteHandler)))
	http.HandleFunc("/v1/organizations/{org_id}/mailboxes/{mailbox_id}/impersonate", withSecurityHeaders(withCORS(mailboxImpersonateHandler)))
	...
	http.HandleFunc("/v1/organizations/{org_id}/recovery-principals/{principal_id}", withSecurityHeaders(withCORS(recoveryPrincipalsHandler)))
	http.HandleFunc("/v1/organizations/{org_id}/recovery-principals/{principal_id}/revoke", withSecurityHeaders(withCORS(recoveryPrincipalsHandler)))
	...
	http.HandleFunc("/v1/mailboxes/{mailbox_id}/messages/{message_id}/body", withSecurityHeaders(withCORS(messageBodyHandler)))
	http.HandleFunc("/v1/mailboxes/{mailbox_id}/messages/{message_id}/folder", withSecurityHeaders(withCORS(messageFolderHandler)))
	http.HandleFunc("/v1/mailboxes/{mailbox_id}/messages/{message_id}/labels", withSecurityHeaders(withCORS(messageLabelsHandler)))
	http.HandleFunc("/v1/mailboxes/{mailbox_id}/messages/{message_id}/labels/{label_id}", withSecurityHeaders(withCORS(messageLabelsHandler)))
	http.HandleFunc("/v1/mailboxes/{mailbox_id}/messages/{message_id}/read", withSecurityHeaders(withCORS(messageReadHandler)))
	http.HandleFunc("/v1/mailboxes/{mailbox_id}/messages/import", withSecurityHeaders(withCORS(messageImportHandler)))
	http.HandleFunc("/v1/organizations/{org_id}/aliases", withSecurityHeaders(withCORS(organizationAliasesHandler)))
	http.HandleFunc("/v1/mailboxes/{mailbox_id}/aliases", withSecurityHeaders(withCORS(mailboxAliasesHandler)))
	http.HandleFunc("/v1/mailboxes/{mailbox_id}/aliases/{alias_id}", withSecurityHeaders(withCORS(mailboxAliasItemHandler)))
	...
	http.HandleFunc("/v1/mailboxes/{mailbox_id}/folders", withSecurityHeaders(withCORS(mailboxFoldersHandler)))
	http.HandleFunc("/v1/mailboxes/{mailbox_id}/folders/{folder_id}", withSecurityHeaders(withCORS(mailboxFoldersHandler)))
	http.HandleFunc("/v1/mailboxes/{mailbox_id}/labels", withSecurityHeaders(withCORS(mailboxLabelsHandler)))
	http.HandleFunc("/v1/mailboxes/{mailbox_id}/labels/{label_id}", withSecurityHeaders(withCORS(mailboxLabelsHandler)))
	...
	http.HandleFunc("/v1/mailboxes/{mailbox_id}/settings", withSecurityHeaders(withCORS(mailboxSettingsHandler)))
	http.HandleFunc("/v1/auth/sessions", withSecurityHeaders(withCORS(sessionsHandler)))
	http.HandleFunc("/v1/auth/sessions/revoke-others", withSecurityHeaders(withCORS(revokeOtherSessionsHandler)))
	http.HandleFunc("/v1/auth/verify-password", withSecurityHeaders(withCORS(verifyPasswordHandler)))
	// Two-Factor Authentication (2FA / TOTP)
	http.HandleFunc("/v1/auth/2fa/status", withSecurityHeaders(withCORS(twoFactorStatusHandler)))
	http.HandleFunc("/v1/auth/2fa/totp/setup", withSecurityHeaders(withCORS(totpSetupHandler)))
	http.HandleFunc("/v1/auth/2fa/totp/verify", withSecurityHeaders(withCORS(totpVerifyHandler)))
	http.HandleFunc("/v1/auth/2fa/totp/disable", withSecurityHeaders(withCORS(totpDisableHandler)))
	http.HandleFunc("/v1/auth/2fa/recovery-methods", withSecurityHeaders(withCORS(recoveryMethodsHandler)))
	http.HandleFunc("/v1/auth/2fa/verify-login", withSecurityHeaders(withCORS(login2FAVerifyHandler)))
	http.HandleFunc("/v1/auth/2fa/send-code", withSecurityHeaders(withCORS(login2FASendCodeHandler)))
	...
	// Filters & Address Rules
	http.HandleFunc("/v1/mailboxes/{mailbox_id}/filters", withSecurityHeaders(withCORS(mailboxFiltersHandler)))
	http.HandleFunc("/v1/mailboxes/{mailbox_id}/filters/{filter_id}", withSecurityHeaders(withCORS(mailboxFilterItemHandler)))
	http.HandleFunc("/v1/mailboxes/{mailbox_id}/address-rules", withSecurityHeaders(withCORS(mailboxAddressRulesHandler)))
	http.HandleFunc("/v1/mailboxes/{mailbox_id}/address-rules/{rule_id}", withSecurityHeaders(withCORS(mailboxAddressRuleItemHandler)))
	...
	http.HandleFunc("/v1/auth/passkeys/register-options", withSecurityHeaders(withCORS(passkeyRegisterOptionsHandler)))
	http.HandleFunc("/v1/auth/passkeys/register", withSecurityHeaders(withCORS(passkeyRegisterHandler)))
	http.HandleFunc("/v1/auth/passkeys/login-options", withSecurityHeaders(withCORS(passkeyLoginOptionsHandler)))
	http.HandleFunc("/v1/auth/passkeys/login", withSecurityHeaders(withCORS(passkeyLoginHandler)))
	http.HandleFunc("/v1/auth/passkeys", withSecurityHeaders(withCORS(passkeysListHandler)))
	http.HandleFunc("/v1/auth/passkeys/{id}", withSecurityHeaders(withCORS(passkeyItemHandler)))

	// Proton Two-Tier Identity Recovery & Historical Key Reactivation
	http.HandleFunc("/v1/auth/recovery/options", withSecurityHeaders(withCORS(recoveryFlowOptionsHandler)))
	http.HandleFunc("/v1/auth/recovery/request", withSecurityHeaders(withCORS(recoveryFlowRequestHandler)))
	http.HandleFunc("/v1/auth/recovery/reset-password", withSecurityHeaders(withCORS(recoveryFlowResetPasswordHandler)))
	http.HandleFunc("/v1/mailboxes/{mailbox_id}/reactivate-keys", withSecurityHeaders(withCORS(mailboxReactivateKeysHandler)))
